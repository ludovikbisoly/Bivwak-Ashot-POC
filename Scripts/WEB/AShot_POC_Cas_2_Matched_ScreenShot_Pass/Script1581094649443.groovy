...
'Compare if element in root patch is matched with the baselined image'
 ...
 'Compare Screenshot' 
 CustomKeywords.'kms.turing.katalon.plugins.visualtesting.ImageComparison.areMatched'(baseline_folder  + 'fullscreen_PDI_FR.png', screenshot_folder + 'fullscreen_PDI_FR.png', FailureHandling.OPTIONAL)
 
 'Get difference ratio of two images' 
 def ratio = CustomKeywords.'kms.turing.katalon.plugins.visualtesting.ImageComparison.getDifferenceRatio'(baseline_folder  + 'fullscreen_PDI_FR.png', screenshot_folder + 'fullscreen_PDI_FR.png', FailureHandling.OPTIONAL)
